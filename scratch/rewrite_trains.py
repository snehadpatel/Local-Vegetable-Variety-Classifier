...
def main():
    ...
    early_stopping = EarlyStopping(patience=3, verbose=True, path="{model_weights_path}")
    ...
    print("\\n" + "="*50)
    print("           TRAINING {model_name_upper} ({model_number})")
    print("="*50)
    ...
    plt.title("Loss Curves ({model_class})")
    plt.xlabel("Epoch")
    plt.ylabel("Loss")
    plt.legend()
    plt.grid(True)
    ...
    plt.title("Accuracy Curves ({model_class})")
    plt.xlabel("Epoch")
    plt.ylabel("Accuracy")
    plt.legend()
    plt.grid(True)
    ...
    plt.tight_layout()
    plt.savefig("{model_curves_path}")
    print("Saved learning curves as '{model_curves_path}'.")
...
models = [
    {
        "filename": "train_light_cnn.py",
        "model_class": "CustomLightCNN",
        "model_weights_path": "light_model.pth",
        "model_curves_path": "light_curves.png",
        "model_name_upper": "CUSTOMLIGHTCNN",
        "model_number": "MODEL 1"
    },
    {
        "filename": "train_deep_cnn.py",
        "model_class": "CustomDeepCNN",
        "model_weights_path": "deep_model.pth",
        "model_curves_path": "deep_curves.png",
        "model_name_upper": "CUSTOMDEEPCNN",
        "model_number": "MODEL 2"
    },
    {
        "filename": "train_gap_cnn.py",
        "model_class": "CustomGAPCNN",
        "model_weights_path": "gap_model.pth",
        "model_curves_path": "gap_curves.png",
        "model_name_upper": "CUSTOMGAPCNN",
        "model_number": "MODEL 3"
    },
    {
        "filename": "train_multiscale_cnn.py",
        "model_class": "CustomMultiScaleCNN",
        "model_weights_path": "multiscale_model.pth",
        "model_curves_path": "multiscale_curves.png",
        "model_name_upper": "CUSTOMMULTISCALECNN",
        "model_number": "MODEL 4"
    },
    {
        "filename": "train_residual_cnn.py",
        "model_class": "CustomResidualCNN",
        "model_weights_path": "residual_model.pth",
        "model_curves_path": "residual_curves.png",
        "model_name_upper": "CUSTOMRESIDUALCNN",
        "model_number": "MODEL 5"
    },
    {
        "filename": "train_depthwise_cnn.py",
        "model_class": "CustomDepthwiseSepCNN",
        "model_weights_path": "depthwise_model.pth",
        "model_curves_path": "depthwise_curves.png",
        "model_name_upper": "CUSTOMDEPTHWISESEPCNN",
...
for m in models:
    content = template.format(
        ...
        model_weights_path=m['model_weights_path'],
        model_name_upper=m['model_name_upper'],
        model_number=m['model_number'],
        model_curves_path=m['model_curves_path']
    )
    with open(m['filename'], 'w') as f:
        f.write(content)

print("Successfully rewrote all 6 training files with the Unified Training Loop!")
